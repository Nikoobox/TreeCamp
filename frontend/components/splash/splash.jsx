    ...
    return (
      <div className="splash-main">
        <div className="splash-main-title-box">
          ...
          <div className="splash-main-subtitle">
            Book one of these tree house cabin rentals today and stay in the
            trees!
          </div>
        </div>
          ...
          <div className="image-box">
            ...
            <div className="image-box-box">
              ...
              <div className="box-sub">
                Join our community of brave tree house lovers and nature
                enthusiasts
              </div>
              <ScrollLink
                to="/"
