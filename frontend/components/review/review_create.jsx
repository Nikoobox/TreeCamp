...
class ReviewCreate extends React.Component {
  ...
  updateRating() {
    let newRating = 0;
    let revSum = 0;
    this.props.fetchReviews(this.props.spot.id).then((res) => {
      ...
      const spotEdit = Object.assign({}, this.props.spot, {
        rating: newRating * 10,
      });
    ...
    return (
      <div className="review-create-container">
        ...
        <form onSubmit={this.handleSubmit} className="review-form">
          ...
          <label className="rating-header">Rate your experience (1-10):</label>
          <input
            className="section"
            placeholder="rating"
            type="number"
